...
def _transition(
    ...
    *,
    ...
    streamlined = workflow_is_streamlined("accounting.product_mapping") and action == "approve"
    ...
    if action in {"approve", "return"} and str(document.get("created_by")) == str(actor["_id"]) and not streamlined:
